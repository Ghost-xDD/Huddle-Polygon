  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const metadata = await client.store({
        name: postTitle,
        description: `${authorName}, ${imageDescription},`,
        image: imageFile,
      });
            ...
            hover:file:cursor-pointer hover:file:opacity-80"
                ...
                <div className="pb-6 sm:mt-0 sm:col-span-2">
                  ...
                  <textarea
                    ...
                    type="text"
                    className="w-[300px] p-2 px-4 pb-16 block max-w-lg w-full shadow-sm focus:ring-red-500 focus:border-red-500 sm:text-sm border border-gray-300 rounded-md"
                    required
                    placeholder="Set an Image description"
